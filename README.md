...
| `writing-commit-messages` | Required gate before every commit — why-grounded messages matching each repo's style | [README](skills/writing-commit-messages/README.md) |
